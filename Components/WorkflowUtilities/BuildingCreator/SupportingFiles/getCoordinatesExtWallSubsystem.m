...
% Copyright 2025 The MathWorks, Inc.
    ...
    numExtWalls = size(NameValueArgs.BuildingData.apartment1.room1.geometry.dim.plotWallVert2D,1)/...
                       NameValueArgs.BuildingData.apartment1.room1.geometry.dim.topFloorLevelNum; % size(extWallVert,1);
    ...
    id_allExtWallVertices = NameValueArgs.BuildingData.apartment1.room1.geometry.dim.plotWallVert2D(id,10);

    if id_allExtWallVertices == size(NameValueArgs.BuildingData.apartment1.room1.geometry.dim.allExtWallVertices,1) %numExtWalls
        wVec1 = NameValueArgs.BuildingData.apartment1.room1.geometry.dim.allExtWallVertices(id_allExtWallVertices,:);
        wVec2 = NameValueArgs.BuildingData.apartment1.room1.geometry.dim.allExtWallVertices(1,:);
    else
        wVec1 = NameValueArgs.BuildingData.apartment1.room1.geometry.dim.allExtWallVertices(id_allExtWallVertices,:);
        wVec2 = NameValueArgs.BuildingData.apartment1.room1.geometry.dim.allExtWallVertices(id_allExtWallVertices+1,:);
    end
